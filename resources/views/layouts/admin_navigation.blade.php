...
<ul class="space-y-4 w-full">
    ...
    <!-- Clients -->
    <li>
    <a href="#" class="flex items-center text-white text-xl py-3 px-4 font-hanken tracking-tight rounded-lg hover:outline hover:outline-2 hover:outline-white hover:text-white transition-all">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-7 w-7 mr-5">
