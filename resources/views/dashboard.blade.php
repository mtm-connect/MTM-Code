    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 w-full">
                ...
                <div class="bg-emerald-950 rounded-xl border shadow-sm p-0 flex flex-col items-center text-center">
                ...
                <div class="bg-white rounded-xl border shadow-sm p-0 flex flex-col">
