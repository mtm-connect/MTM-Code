...
<label class="inline-flex flex-col items-center cursor-pointer group">
    <input 
        ...
        id="single1" 
        class="hidden peer" 
        {{ old('jacket_type') == 'Single 1 Button' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer group">
    <input 
        ...
        class="hidden peer" 
        {{ old('jacket_type') == 'Single 2 Buttons' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer group">
    <input 
        ...
        class="hidden peer" 
        {{ old('jacket_type') == 'Single 3 Buttons' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer group">
    <input 
        ...
        class="hidden peer" 
        {{ old('jacket_type') == 'Single 4 Buttons' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer">
    <input 
        ...
        class="hidden peer" 
        {{ old('jacket_type') == 'Double Breast 4 on 1' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer">
    <input 
        ...
        class="hidden peer" 
        {{ old('jacket_type') == 'Double Breast 4 on 2' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer">
    <input 
        ...
        class="hidden peer" 
        {{ old('jacket_type') == 'Double Breast 6 on 2' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer">
    <input 
        ...
        class="hidden peer" 
        {{ old('jacket_type') == 'Double Breast 6 on 3' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer">
    <input 
        ...
        value="3 Roll 2" 
        class="hidden peer" 
        {{ old('jacket_type') == '3 Roll 2' ? 'checked' : '' }}>

    <div class="w-64 h-80 p-5 bg-cover bg-center rounded-xl border-2 peer-checked:border-emerald-95  flex flex-col items-center justify-center">
...
<label class="inline-flex flex-col items-center cursor-pointer">
    <input 
        ...
        value="Full Canvas" 
        class="hidden peer"
        {{ old('jacket_construction') == 'Full Canvas' ? 'checked' : '' }}>
...
<label class="inline-flex flex-col items-center cursor-pointer">
    <input 
        ...
        value="Half Canvas" 
        class="hidden peer"
        {{ old('jacket_construction') == 'Half Canvas' ? 'checked' : '' }}>
...
<div class="mt-20   ">
    <x-input-label class="text-l text-center py-2 px-4 rounded-t-lg  bg-emerald-950 text-white" for="jacket_construction" for="jacket_lapel_type" :value="__('Jacket Lapel Type')" />
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Notch Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type') == 'Notch Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Peak Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type') == 'Peak Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Shawl Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type') == 'Shawl Lapel' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel') == 'No Satin Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel') == 'Satin Front Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel') == 'Satin Front Including Back Collar' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_hand_stitch') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_hand_stitch') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Thinner" 
                class="hidden peer"
                {{ old('jacket_lapel_width') == 'Thinner' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Regular" 
                class="hidden peer"
                {{ old('jacket_lapel_width') == 'Regular' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Wider" 
                class="hidden peer"
                {{ old('jacket_lapel_width') == 'Wider' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Decorative" 
                class="hidden peer"
                {{ old('jacket_lapel_functional_button') == 'Decorative' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Functional" 
                class="hidden peer"
                {{ old('jacket_lapel_functional_button') == 'Functional' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-4 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons') == '2 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons') == '3 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons') == '4 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons') == '5 Sleeve Buttons' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Decorative" 
                class="hidden peer"
                {{ old('jacket_functional_buttons') == 'Decorative' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Functional" 
                class="hidden peer"
                {{ old('jacket_functional_buttons') == 'Functional' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_buttons_colour_on_last_button_hole') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_buttons_colour_on_last_button_hole') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Full Lining" 
                class="hidden peer"
                {{ old('jacket_lining') == 'Full Lining' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Half Lining" 
                class="hidden peer"
                {{ old('jacket_lining') == 'Half Lining' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Lining" 
                class="hidden peer"
                {{ old('jacket_lining') == 'No Lining' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets') == 'No Pockets' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="2 Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets') == '2 Pockets' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="3 Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets') == '3 Pockets' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_pockets_with_flap') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_pockets_with_flap') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_italian_pockets') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_italian_pockets') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_patch_pockets') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_patch_pockets') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_pockets_satin_piping') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_pockets_satin_piping') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type') == 'Curved Chest Pocket' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type') == 'Patch Chest Pocket' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type') == 'Satin Chest Pocket' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Vent" 
                class="hidden peer"
                {{ old('jacket_vents') == 'No Vent' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Single Vent" 
                class="hidden peer"
                {{ old('jacket_vents') == 'Single Vent' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Double Vent" 
                class="hidden peer"
                {{ old('jacket_vents') == 'Double Vent' ? 'checked' : '' }}>
