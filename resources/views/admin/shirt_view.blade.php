...
$Shirt_Collars_Images = [
    'Classic' => 'classic.png',
    'Cutaway' => 'cutaway.png',
    'Italian Spread' => 'italian-spread.png',
    'Special 1' => 'special1.png',
    'Special 2' => 'special2.png',
];

$Shirt_Collar_Buttons_Images = [
    '1 Button' => '1_button.png',
    '2 Buttons Classic' => '2_buttons_classic.png',
    '2 Buttons Tall' => '2_buttons_tall.png',
    '3 Buttons' => '3_buttons.png',
];

$Shirt_Collar_Button_Down_Images = [
    'No Button Down' => 'no_button_down.png',
    'Button Down' => 'button_down.png',
    'Hidden Button Down' => 'hidden_button_down.png',
    
];

$Shirt_Cuff_Images = [
    '1 Button Round' => '1_button_round.png',
    '2 Button Round' => '2_button_round.png',
    '1 Button Angle' => '1_button_angle.png',
    '2 Button Angle' => '2_button_angle.png',
    'French Square' => 'french_square.png',
    'French Angle' => 'french_angle.png',
    'Cocktail' => 'cocktail.png',
    
];

$Shirt_Contrast_Images = [
    'No Contrast' => 'standard.png',
    'Contrast 1' => 'contrast_1.png',
    'Contrast 2' => 'contrast_2.png',
];

$Shirt_Placket_Images = [
    'Standard Placket' => 'no_contrast.png',
    'No Placket' => 'no.png',
    'Concealed Placket' => 'concealed.png',
];

$Shirt_Pleat_Images = [
    'Two Side Pleat' => 'two_side.png',
    'Center Pleat' => 'center.png',
    'No Pleat' => 'no.png',
];

$Shirt_Bottom_Images = [
    'Round Bottom' => 'round.png',
    'Straight Bottom' => 'straight.png',
];
...
$Shirt_Collars_Image = getImage($Shirt_Collars_Images, $selectedItem, 'collar', 'shirt/collars');
$Shirt_Collar_Buttons_Image = getImage($Shirt_Collar_Buttons_Images, $selectedItem, 'collar_buttons', 'shirt/collar_buttons');
$Shirt_Collar_Button_Down_Image = getImage($Shirt_Collar_Button_Down_Images, $selectedItem, 'collar_button_down', 'shirt/collar_buttons');
$Shirt_Cuff_Image = getImage($Shirt_Cuff_Images, $selectedItem, 'cuff', 'shirt/cuffs');
$Shirt_Contrast_Image = getImage($Shirt_Contrast_Images, $selectedItem, 'contrast', 'shirt/contrasts');
$Shirt_Placket_Image = getImage($Shirt_Placket_Images, $selectedItem, 'placket', 'shirt/placket');
$Shirt_Pleat_Image = getImage($Shirt_Pleat_Images, $selectedItem, 'pleat', 'shirt/pleat');
$Shirt_Bottom_Image = getImage($Shirt_Bottom_Images, $selectedItem, 'bottom', 'shirt/bottom');
$Shirt_Pocket_Image = getImage($Shirt_Pocket_Images, $selectedItem, 'pocket', 'shirt/pocket');
$Shirt_Fit_Image = getImage($Shirt_Fit_Images, $selectedItem, 'fit', 'shirt/fit');
...
@section('content')
    ...
    <h2 class="font-semibold text-m text-gray-800 leading-tight">
        Item Number: (#{{ $selectedshirt->item_number }})
    </h2>
</div>
...
<!-- Color Codes Section -->
<div class="bg-emerald-950 grid grid-cols-3 gap-4 place-items-center mx-auto rounded-xl mt-6 mb-6 py-10">

    <!-- Shirt Fabric Code -->
    <div class="flex flex-col items-center">
        <p class="text-m mb-2 text-white">Shirt Fabric</p>
        <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
        <p class="font-bold text-xl">{{ strtoupper($selectedshirt->shirt_fabric_code) }}</p>
    ...
    <div class="flex flex-col items-center">
        <p class="text-m mb-2 text-white">Shirt Buttons</p>
        <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
        <p class="font-bold text-xl">{{ strtoupper($selectedshirt->shirt_button_code) }}</p>

        </div>
    </div>
    @if($selectedshirt->contrast != 'No Contrast')
      <!-- Waistcoat Contrast -->
      <div class="flex flex-col items-center">
        <p class="text-m mb-2 text-white">Shirt Contrast</p>
        <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
        <p class="font-bold text-xl">{{ strtoupper($selectedshirt->shirt_contrast_code) }}</p>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Collars_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->collar }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Collar_Buttons_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->collar_buttons }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Collar_Button_Down_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->collar_button_down }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Cuff_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->cuff }}
        </p>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Contrast_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->contrast }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Placket_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->placket }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Pleat_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->pleat }}
        </p>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Bottom_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->bottom }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Pocket_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->pocket }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Shirt_Fit_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selectedshirt->fit }}
        </p>
