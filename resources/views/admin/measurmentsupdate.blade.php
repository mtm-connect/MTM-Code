            ...
            <div class="mt-4">
                ...
                <div class="mt-2">
                    <label for="male" class="inline-flex items-center">
                        <input type="radio" id="male" name="gender" value="male" class="form-radio focus:ring-emerald-950"
                               {{ $g == 'male' ? 'checked' : '' }} />
                        <span class="ml-2">{{ __('Male') }}</span>
                    </label>
                    <label for="female" class="inline-flex items-center ml-6">
                        <input type="radio" id="female" name="gender" value="female" class="form-radio focus:ring-emerald-950"
                               {{ $g == 'female' ? 'checked' : '' }} />
                    ...
                    <div class="mt-4 grid grid-cols-4 gap-6">
                        <label class="inline-flex flex-col items-center cursor-pointer">
                            <input type="radio" name="bs_posture" value="Scapular Protrusion" class="hidden peer"
                                @checked($bs_posture === 'Scapular Protrusion') />
                            <div
                                class="w-64 h-80 p-5 bg-cover bg-center rounded-xl border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center">
                                <div class="w-full h-full bg-cover bg-center rounded-lg"
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-1">
                            <textarea id="special_requirements" name="special_requirements"
                                ...
                                placeholder="{{ $selectedmeasurement->special_requirements ?? 'Enter special requirements' }}">{{ old('special_requirements', $selectedmeasurement->special_requirements ?? '') }}</textarea>
                        </div>
