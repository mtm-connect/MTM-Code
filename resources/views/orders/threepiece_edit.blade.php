...
<h2 class="font-semibold text-m text-gray-800 leading-tight mb-10 text-center">
    ...
    <form method="POST" action="{{ route('three.update', $selected_threepiece->id) }}">
        @csrf
        @method('PUT')
    ...
    <div class="mt-4 grid grid-cols-4 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer group">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selected_threepiece->jacket_type ?? '') == 'Single 1 Button' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer group">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selected_threepiece->jacket_type ?? '') == 'Single 2 Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer group">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selected_threepiece->jacket_type ?? '') == 'Single 3 Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer group">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selected_threepiece->jacket_type ?? '') == 'Single 4 Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selected_threepiece->jacket_type ?? '') == 'Double Breast 4 on 1' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selected_threepiece->jacket_type ?? '') == 'Double Breast 6 on 3' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="3 Roll 2" 
                class="hidden peer" 
                {{ old('jacket_type', $selected_threepiece->jacket_type ?? '') == '3 Roll 2' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Full Canvas" 
                class="hidden peer"
                {{ old('jacket_construction', $selected_threepiece->jacket_construction ?? '') == 'Full Canvas' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Half Canvas" 
                class="hidden peer"
                {{ old('jacket_construction', $selected_threepiece->jacket_construction ?? '') == 'Half Canvas' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Notch Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type', $selected_threepiece->jacket_lapel_type ?? '') == 'Notch Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Peak Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type', $selected_threepiece->jacket_lapel_type ?? '') == 'Peak Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Shawl Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type', $selected_threepiece->jacket_lapel_type ?? '') == 'Shawl Lapel' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel', $selected_threepiece->jacket_satin_lapel ?? '') == 'No Satin Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel', $selected_threepiece->jacket_satin_lapel ?? '') == 'Satin Front Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel', $selected_threepiece->jacket_satin_lapel ?? '') == 'Satin Front Including Back Collar' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_hand_stitch', $selected_threepiece->jacket_hand_stitch ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_hand_stitch', $selected_threepiece->jacket_hand_stitch ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Thinner" 
                class="hidden peer"
                {{ old('jacket_lapel_width', $selected_threepiece->jacket_lapel_width ?? '') == 'Thinner' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Regular" 
                class="hidden peer"
                {{ old('jacket_lapel_width', $selected_threepiece->jacket_lapel_width ?? '') == 'Regular' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Wider" 
                class="hidden peer"
                {{ old('jacket_lapel_width', $selected_threepiece->jacket_lapel_width ?? '') == 'Wider' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Decorative" 
                class="hidden peer"
                {{ old('jacket_lapel_functional_button', $selected_threepiece->jacket_lapel_functional_button ?? '') == 'Decorative' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Functional" 
                class="hidden peer"
                {{ old('jacket_lapel_functional_button', $selected_threepiece->jacket_lapel_functional_button ?? '') == 'Functional' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-4 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons', $selected_threepiece->jacket_sleeve_buttons ?? '') == '2 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons', $selected_threepiece->jacket_sleeve_buttons ?? '') == '3 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons', $selected_threepiece->jacket_sleeve_buttons ?? '') == '4 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons', $selected_threepiece->jacket_sleeve_buttons ?? '') == '5 Sleeve Buttons' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Decorative" 
                class="hidden peer"
                {{ old('jacket_functional_buttons', $selected_threepiece->jacket_functional_buttons ?? '') == 'Decorative' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Functional" 
                class="hidden peer"
                {{ old('jacket_functional_buttons', $selected_threepiece->jacket_functional_buttons ?? '') == 'Functional' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_buttons_colour_on_last_button_hole', $selected_threepiece->jacket_buttons_colour_on_last_button_hole ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_buttons_colour_on_last_button_hole', $selected_threepiece->jacket_buttons_colour_on_last_button_hole ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Full Lining" 
                class="hidden peer"
                {{ old('jacket_lining', $selected_threepiece->jacket_lining ?? '') == 'Full Lining' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Half Lining" 
                class="hidden peer"
                {{ old('jacket_lining', $selected_threepiece->jacket_lining ?? '') == 'Half Lining' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Lining" 
                class="hidden peer"
                {{ old('jacket_lining', $selected_threepiece->jacket_lining ?? '') == 'No Lining' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets', $selected_threepiece->jacket_pockets ?? '') == 'No Pockets' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="2 Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets', $selected_threepiece->jacket_pockets ?? '') == '2 Pockets' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="3 Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets', $selected_threepiece->jacket_pockets ?? '') == '3 Pockets' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_pockets_with_flap', $selected_threepiece->jacket_pockets_with_flap ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_pockets_with_flap', $selected_threepiece->jacket_pockets_with_flap ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_italian_pockets', $selected_threepiece->jacket_italian_pockets ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_italian_pockets', $selected_threepiece->jacket_italian_pockets ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_patch_pockets', $selected_threepiece->jacket_patch_pockets ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_patch_pockets', $selected_threepiece->jacket_patch_pockets ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_pockets_satin_piping', $selected_threepiece->jacket_pockets_satin_piping ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_pockets_satin_piping', $selected_threepiece->jacket_pockets_satin_piping ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type', $selected_threepiece->jacket_chest_pocket_type ?? '') == 'Curved Chest Pocket' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type', $selected_threepiece->jacket_chest_pocket_type ?? '') == 'Patch Chest Pocket' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type', $selected_threepiece->jacket_chest_pocket_type ?? '') == 'Satin Chest Pocket' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Vent" 
                class="hidden peer"
                {{ old('jacket_vents', $selected_threepiece->jacket_vents ?? '') == 'No Vent' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Single Vent" 
                class="hidden peer"
                {{ old('jacket_vents', $selected_threepiece->jacket_vents ?? '') == 'Single Vent' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Double Vent" 
                class="hidden peer"
                {{ old('jacket_vents', $selected_threepiece->jacket_vents ?? '') == 'Double Vent' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-4 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q001+DD4 Point Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q003+DD5 Point Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q004+DD4 Round Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q008+DD4 Point Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q009+DD4 Straight Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q012+DD4 Point Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q013+DD4 Straight Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q011+DD4 Point Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q010+DD4 Point Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q016+DD4 Point Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q018+DD4 Straight Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q019+DD4 Straight Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q020+DD4 Point Bottom' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('waistcoat_type', $selected_threepiece->waistcoat_type ?? '') == 'Q021+DD4 Straight Bottom' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Straight" 
                class="hidden peer"
                {{ old('pants_pocket', $selected_threepiece->pants_pocket ?? '') == 'Straight' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Slanted" 
                class="hidden peer"
                {{ old('pants_pocket', $selected_threepiece->pants_pocket ?? '') == 'Slanted' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="extended" 
                class="hidden peer"
                {{ old('pants_extended_waist_strap', $selected_threepiece->pants_extended_waist_strap ?? '') == 'extended' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="regular" 
                class="hidden peer"
                {{ old('pants_extended_waist_strap', $selected_threepiece->pants_extended_waist_strap ?? '') == 'regular' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Pleat" 
                class="hidden peer"
                {{ old('pants_pleats', $selected_threepiece->pants_pleats ?? '') == 'No Pleat' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Single Pleat" 
                class="hidden peer"
                {{ old('pants_pleats', $selected_threepiece->pants_pleats ?? '') == 'Single Pleat' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Double Pleat" 
                class="hidden peer"
                {{ old('pants_pleats', $selected_threepiece->pants_pleats ?? '') == 'Double Pleat' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-4 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('pants_back_pocket_type', $selected_threepiece->pants_back_pocket_type ?? '') == 'No Back Pocket' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('pants_back_pocket_type', $selected_threepiece->pants_back_pocket_type ?? '') == '2 Back Pockets' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('pants_back_pocket_type', $selected_threepiece->pants_back_pocket_type ?? '') == '1 Left Back Pocket' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('pants_back_pocket_type', $selected_threepiece->pants_back_pocket_type ?? '') == '1 Right Back Pocket' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('pants_back_pocket_with_buttons', $selected_threepiece->pants_back_pocket_with_buttons ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('pants_back_pocket_with_buttons', $selected_threepiece->pants_back_pocket_with_buttons ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('pants_back_pocket_with_flap', $selected_threepiece->pants_back_pocket_with_flap ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('pants_back_pocket_with_flap', $selected_threepiece->pants_back_pocket_with_flap ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('pants_pant_cuffs', $selected_threepiece->pants_pant_cuffs ?? '') == 'With Pant Cuff (1.5&quot;)' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Pant Cuff" 
                class="hidden peer"
                {{ old('pants_pant_cuffs', $selected_threepiece->pants_pant_cuffs ?? '') == 'No Pant Cuff' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('pants_side_adjusters', $selected_threepiece->pants_side_adjusters ?? '') == 'Side Adjusters with No Belt Loops' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('pants_side_adjusters', $selected_threepiece->pants_side_adjusters ?? '') == 'Side Adjusters with Belt Loops' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('pants_side_adjusters', $selected_threepiece->pants_side_adjusters ?? '') == 'No Side Adjusters' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('pants_satin_tape_on_side', $selected_threepiece->pants_satin_tape_on_side ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('pants_satin_tape_on_side', $selected_threepiece->pants_satin_tape_on_side ?? '') == 'No' ? 'checked' : '' }}>
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        type="text" 
        name="code_jacket" 
        :value="old('code_jacket', $selected_threepiece->code_jacket ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_jacket_lining', $selected_threepiece->code_jacket_lining ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_jacket_button', $selected_threepiece->code_jacket_button ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_satin_lapel', $selected_threepiece->code_satin_lapel ?? '')" 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_colour_on_last_button_hole', $selected_threepiece->code_colour_on_last_button_hole ?? '')" 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        type="text" 
        name="code_waistcoat" 
        :value="old('code_waistcoat', $selected_threepiece->code_waistcoat ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_waistcoat_buttons', $selected_threepiece->code_waistcoat_buttons ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        type="text" 
        name="code_pants" 
        :value="old('code_pants', $selected_threepiece->code_pants ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_pants_button', $selected_threepiece->code_pants_button ?? '')" 
        required 
