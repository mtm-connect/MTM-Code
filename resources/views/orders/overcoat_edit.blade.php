<x-app-layout>
    ...
    <div class="mt-16 mx-40">
        ...
        <form method="POST" action="{{ route('overcoats.update', $selected_overcoat->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mt-6">
                <x-input-label class="text-l text-center py-2 px-4 rounded-t-lg bg-emerald-950 text-white"
                    for="overcoat_type" :value="__('Overcoat Type')" />

                <div class="mt-4 grid grid-cols-4 gap-4">
                    <!-- Single 1 Button -->
                    <label class="inline-flex flex-col items-center cursor-pointer group">
                        <input type="radio" name="overcoat_type" value="Single 1 Button" class="hidden peer"
                            {{ old('overcoat_type', $selected_overcoat->overcoat_type ?? '') == 'Single 1 Button' ? 'checked' : '' }}>

                        <div
                            class="w-64 h-80 p-5 bg-cover bg-center rounded-xl border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center relative group">
                    ...
                    <!-- Single 2 Buttons -->
                    <label class="inline-flex flex-col items-center cursor-pointer group">
                        <input type="radio" name="overcoat_type" value="Single 2 Buttons" class="hidden peer"
                            {{ old('overcoat_type', $selected_overcoat->overcoat_type ?? '') == 'Single 2 Buttons' ? 'checked' : '' }}>
                    ...
                    <!-- Single 3 Buttons -->
                    <label class="inline-flex flex-col items-center cursor-pointer group">
                        <input type="radio" name="overcoat_type" value="Single 3 Buttons" class="hidden peer"
                            {{ old('overcoat_type', $selected_overcoat->overcoat_type ?? '') == 'Single 3 Buttons' ? 'checked' : '' }}>
                    ...
                    <!-- Single 4 Buttons -->
                    <label class="inline-flex flex-col items-center cursor-pointer group">
                        <input type="radio" name="overcoat_type" value="Single 4 Buttons" class="hidden peer"
                            {{ old('overcoat_type', $selected_overcoat->overcoat_type ?? '') == 'Single 4 Buttons' ? 'checked' : '' }}>
                    ...
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_type" value="Double Breast 4 on 1" class="hidden peer"
                            {{ old('overcoat_type', $selected_overcoat->overcoat_type ?? '') == 'Double Breast 4 on 1' ? 'checked' : '' }}>
                    ...
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_type" value="Double Breast 6 on 3" class="hidden peer"
                            {{ old('overcoat_type', $selected_overcoat->overcoat_type ?? '') == 'Double Breast 6 on 3' ? 'checked' : '' }}>
                    ...
                    <!-- 3 Roll 2 -->
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_type" value="3 Roll 2" class="hidden peer"
                            {{ old('overcoat_type', $selected_overcoat->overcoat_type ?? '') == '3 Roll 2' ? 'checked' : '' }}>
            ...
            <div class="mt-20 border-emerald-950">
                <x-input-label class="text-l text-center py-2 px-4 rounded-t-lg bg-emerald-950 text-white"
                    for="overcoat_construction" :value="__('Overcoat Construction')" />

                <div class="mt-4 grid grid-cols-2 gap-4">
                    <!-- Full Canvas -->
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_construction" value="Full Canvas" class="hidden peer"
                            {{ old('overcoat_construction', $selected_overcoat->overcoat_construction ?? '') == 'Full Canvas' ? 'checked' : '' }}>

                        <div
                            class="w-64 h-80 p-5 bg-cover bg-center rounded-xl border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center">
                            <div class="w-full h-full bg-cover bg-center rounded-lg"
                                style="background-image: url({{ asset('images/canvas/full.png') }});"></div>
                    ...
                    <!-- Half Canvas -->
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_construction" value="Half Canvas" class="hidden peer"
                            {{ old('overcoat_construction', $selected_overcoat->overcoat_construction ?? '') == 'Half Canvas' ? 'checked' : '' }}>

                        <div
                            class="w-64 h-80 p-5 bg-cover bg-center rounded-xl border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center">
                            <div class="w-full h-full bg-cover bg-center rounded-lg"
                                style="background-image: url('{{ asset('images/canvas/half.png') }}');"></div>
            ...
            <div class="mt-20">
                <x-input-label class="text-l text-center py-2 px-4 rounded-t-lg bg-emerald-950 text-white"
                    for="overcoat_lapel_type" :value="__('Overcoat Lapel Type')" />

                <div class="mt-4 grid grid-cols-3 gap-4">
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_lapel_type" value="Notch Lapel" class="hidden peer"
                            {{ old('overcoat_lapel_type', $selected_overcoat->overcoat_lapel_type ?? '') == 'Notch Lapel' ? 'checked' : '' }}>
                    ...
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_lapel_type" value="Peak Lapel" class="hidden peer"
                            {{ old('overcoat_lapel_type', $selected_overcoat->overcoat_lapel_type ?? '') == 'Peak Lapel' ? 'checked' : '' }}>
                        <div class="w-64 h-80 p-5 bg-cover bg-center rounded-lg border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center">
                    ...
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_lapel_type" value="Shawl Lapel" class="hidden peer"
                            {{ old('overcoat_lapel_type', $selected_overcoat->overcoat_lapel_type ?? '') == 'Shawl Lapel' ? 'checked' : '' }}>
                        <div class="w-64 h-80 p-5 bg-cover bg-center rounded-lg border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center">
            ...
            <div class="mt-20">
                <x-input-label class="text-l text-center py-2 px-4 rounded-t-lg bg-emerald-950 text-white"
                    for="overcoat_satin_lapel" :value="__('Overcoat Satin Lapel Type?')" />

                <div class="mt-4 grid grid-cols-3 gap-4">
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_satin_lapel" value="No Satin Lapel" class="hidden peer"
                            {{ old('overcoat_satin_lapel', $selected_overcoat->overcoat_satin_lapel ?? '') == 'No Satin Lapel' ? 'checked' : '' }}>
                        <div class="w-64 h-80 p-5 bg-cover bg-center rounded-lg border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center">
                    ...
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_satin_lapel" value="Satin Front Lapel" class="hidden peer"
                            {{ old('overcoat_satin_lapel', $selected_overcoat->overcoat_satin_lapel ?? '') == 'Satin Front Lapel' ? 'checked' : '' }}>
                        <div class="w-64 h-80 p-5 bg-cover bg-center rounded-lg border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center">
                    ...
                    <label class="inline-flex flex-col items-center cursor-pointer">
                        <input type="radio" name="overcoat_satin_lapel" value="Satin Front Including Back Collar" class="hidden peer"
                            {{ old('overcoat_satin_lapel', $selected_overcoat->overcoat_satin_lapel ?? '') == 'Satin Front Including Back Collar' ? 'checked' : '' }}>
                        <div class="w-64 h-80 p-5 bg-cover bg-center rounded-lg border-2 peer-checked:border-emerald-950 flex flex-col items-center justify-center">
            ...
            <div class="mt-2">
                ...
                <x-text-input
                    ...
                    type="text"
                    name="code_overcoat"
                    :value="old('code_overcoat', $selected_overcoat->code_overcoat ?? '')"
                    required
            ...
            <div class="mt-2">
                ...
                <x-text-input
                    ...
                    :value="old('code_overcoat_lining', $selected_overcoat->code_overcoat_lining ?? '')"
                    required
            ...
            <div class="mt-2">
                ...
                <x-text-input
                    ...
                    :value="old('code_overcoat_button', $selected_overcoat->code_overcoat_button ?? '')"
                    required
            ...
            <div class="mt-2">
                ...
                <x-text-input
                    ...
                    :value="old('code_satin_lapel', $selected_overcoat->code_satin_lapel ?? '')"
            ...
            <div class="mt-2">
                ...
                <x-text-input
                    ...
                    :value="old('code_colour_on_last_button_hole', $selected_overcoat->code_colour_on_last_button_hole ?? '')"
