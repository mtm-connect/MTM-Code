@php
    /**
     * Overcoat View (based on Jacket View)
     * - Images: EXACT same as jacket (same folders + filenames)
     * - Fields: overcoat_* + code_overcoat*
     */

    $selectedItem = $selected_overcoat ?? null;

    // Function to retrieve image path (same as jacket view)
    function getImage($imagesArray, $selectedItem, $attribute, $folder) {
        return isset($selectedItem->$attribute) && isset($imagesArray[$selectedItem->$attribute])
            ...
            : asset('images/order/default.jpg');
    }

    // ✅ IMAGE MAPS (EXACT SAME AS JACKET)
    $Jacket_Type_Images = [
    ...
    // ✅ Assign images dynamically (ATTRIBUTES ARE OVERCOAT_* but folders are jacket folders)
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden sm:rounded-lg p-6">
                ...
                <div class="flex justify-end items-center mb-10 space-x-4">
                    ...
                    <h2 class="font-semibold text-m text-gray-800 leading-tight">
                        Item Number: (#{{ $selected_overcoat->item_number }})
                    </h2>
                </div>

                {{-- Measurement dropdown (KEEP SAME as jacket_view) --}}
                ...
                <div id="measurementDropdown" class="hidden mt-2 mb-10 w-1/2 bg-white border border-gray-300 rounded-xl p-6 flex justify-center mx-auto transition-all duration-300 ease-in-out opacity-0 max-h-0 overflow-hidden">
                    <table class="w-full max-w-full table-auto p-4">
                        ...
                        <tbody>
                            <tr><td class="border-b px-2 py-1">DOB</td><td class="border-b px-2 py-1">{{ $measurement->dob }}</td></tr>
                            <tr><td class="border-b px-2 py-1">Gender</td><td class="border-b px-2 py-1">{{ $measurement->gender }}</td></tr>
                            <tr><td class="border-b px-2 py-1">Height</td><td class="border-b px-2 py-1">{{ $measurement->height }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Weight</td><td class="border-b px-2 py-1">{{ $measurement->weight }} kg</td></tr>
                            <tr><td class="border-b px-2 py-1">Shoulders</td><td class="border-b px-2 py-1">{{ $measurement->shoulders }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Sleeve Length</td><td class="border-b px-2 py-1">{{ $measurement->sleeve_length }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Bicep</td><td class="border-b px-2 py-1">{{ $measurement->bicep }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Wrist</td><td class="border-b px-2 py-1">{{ $measurement->wrist }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Chest</td><td class="border-b px-2 py-1">{{ $measurement->chest }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Belly</td><td class="border-b px-2 py-1">{{ $measurement->belly }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Waist</td><td class="border-b px-2 py-1">{{ $measurement->waist }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Hip</td><td class="border-b px-2 py-1">{{ $measurement->hip }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Thigh</td><td class="border-b px-2 py-1">{{ $measurement->thigh }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Knee</td><td class="border-b px-2 py-1">{{ $measurement->knee }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Cuff</td><td class="border-b px-2 py-1">{{ $measurement->cuff }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Outside Leg Length</td><td class="border-b px-2 py-1">{{ $measurement->outside_leg_length }} cm</td></tr>
                            <tr><td class="border-b px-2 py-1">Neck</td><td class="border-b px-2 py-1">{{ $measurement->neck }} cm</td></tr>

                            @if($measurement->crotch !== NULL)
                                <tr><td class="border-b px-2 py-1">Crotch</td><td class="border-b px-2 py-1">{{ $measurement->crotch }} cm</td></tr>
                            @endif
                            @if($measurement->inside_leg_length !== NULL)
                                <tr><td class="border-b px-2 py-1">Inside Leg Length</td><td class="border-b px-2 py-1">{{ $measurement->inside_leg_length }} cm</td></tr>
                            @endif
                            @if($measurement->inside_sleeve_length !== NULL)
                                <tr><td class="border-b px-2 py-1">Inside Sleeve Length</td><td class="border-b px-2 py-1">{{ $measurement->inside_sleeve_length }} cm</td></tr>
                            @endif
                            @if($measurement->pants_cuff_width !== NULL)
                                <tr><td class="border-b px-2 py-1">Pants Cuff Width</td><td class="border-b px-2 py-1">{{ $measurement->pants_cuff_width }} cm</td></tr>
                            @endif
                            @if($measurement->jacket_length_front !== NULL)
                                <tr><td class="border-b px-2 py-1">Jacket Length Front</td><td class="border-b px-2 py-1">{{ $measurement->jacket_length_front }} cm</td></tr>
                            @endif

                            <tr><td class="border-b px-2 py-1">BS Shoulders</td><td class="border-b px-2 py-1">{{ $measurement->bs_shoulders }}</td></tr>
                            <tr><td class="border-b px-2 py-1">BS Chest</td><td class="border-b px-2 py-1">{{ $measurement->bs_chest }}</td></tr>
                            <tr><td class="border-b px-2 py-1">BS Stomach</td><td class="border-b px-2 py-1">{{ $measurement->bs_stomach }}</td></tr>
                            <tr><td class="border-b px-2 py-1">BS Posture</td><td class="border-b px-2 py-1">{{ $measurement->bs_posture }}</td></tr>
                            <tr><td class="border-b px-2 py-1">BS Seat</td><td class="border-b px-2 py-1">{{ $measurement->bs_seat }}</td></tr>
                        </tbody>
                    </table>
                </div>
                ...
                <script>
                    function toggleDropdown() {
                        ...
                        if (dropdown.classList.contains('hidden')) {
                            ...
                            setTimeout(() => dropdown.classList.add('opacity-100', 'max-h-screen'), 10);
                        } else {
                ...
                {{-- COLOR CODES (same layout as jacket view, using overcoat codes) --}}
                <div class="bg-emerald-950 grid grid-cols-4 gap-4 place-items-center mx-auto rounded-xl mt-6 mb-6 py-10">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="w-48 h-12 flex items-center justify-center border border-white bg-white rounded-lg">
                            <p class="font-bold text-xl">{{ strtoupper($selected_overcoat->code_overcoat) }}</p>
                        </div>
                    </div>

                    @if($selected_overcoat->overcoat_lining != 'No Lining')
                        <div class="flex flex-col items-center">
                            ...
                            <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
                                <p class="font-bold text-xl">{{ strtoupper($selected_overcoat->code_overcoat_lining) }}</p>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
                            <p class="font-bold text-xl">{{ strtoupper($selected_overcoat->code_overcoat_button) }}</p>
                        </div>
                    </div>

                    @if($selected_overcoat->overcoat_satin_lapel != 'No Satin Lapel')
                        <div class="flex flex-col items-center">
                            <p class="text-m mb-2 text-white">Satin Lapel Colour</p>
                            <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
                                <p class="font-bold text-xl">{{ strtoupper($selected_overcoat->code_satin_lapel) }}</p>
                            </div>
                        </div>
                    @endif

                    @if($selected_overcoat->overcoat_buttons_colour_on_last_button_hole == 'Yes')
                        <div class="flex flex-col items-center col-span-4 sm:col-span-1">
                            <p class="text-m mb-2 text-white">Last Button Hole Colour</p>
                            <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
                                <p class="font-bold text-xl">{{ strtoupper($selected_overcoat->code_colour_on_last_button_hole) }}</p>
                            </div>
                        </div>
                    @endif
                </div>

                {{-- CARDS GRID (same as jacket view, using overcoat values) --}}
                <div class="grid grid-cols-4 gap-4 place-items-center mx-auto">
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_type }}</p>
                            <p class="text-center text-sm mt-2 font-bold">
                                Overcoat Fabric: {{ strtoupper($selected_overcoat->code_overcoat) }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_construction }}</p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_lapel_type }}</p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_satin_lapel }}</p>

                            @if(!is_null($selected_overcoat->code_satin_lapel))
                                <p class="text-center text-sm mt-2 font-bold">
                                    Satin Code: {{ strtoupper($selected_overcoat->code_satin_lapel) }}
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_hand_stitch }}</p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        <p class="text-l text-center py-2 px-4 rounded-t-lg bg-emerald-950 text-white mb-2 w-full">
                            Overcoat Lapel Width
                        </p>
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            <div class="w-full h-full bg-cover bg-center rounded-lg"
                                 style="background-image: url({{ asset($lapel_width_Image) }}); background-size: contain; background-repeat: no-repeat;">
                            </div>
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_lapel_width }}</p>
                        </div>
                    </div>

                    {{-- Lapel Functional Button --}}
                    <div class="rounded-lg flex flex-col items-center">
                        <p class="text-l text-center py-2 px-4 rounded-t-lg bg-emerald-950 text-white mb-2 w-full">
                            Overcoat Lapel Functional Button
                        </p>
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            <div class="w-full h-full bg-cover bg-center rounded-lg"
                                 style="background-image: url({{ asset($lapel_functional_button_Image) }}); background-size: contain; background-repeat: no-repeat;">
                            </div>
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_lapel_functional_button }}</p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        <p class="text-l text-center py-2 px-4 rounded-t-lg bg-emerald-950 text-white mb-2 w-full">
                            Overcoat Sleeve Buttons
                        </p>
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            <div class="w-full h-full bg-cover bg-center rounded-lg"
                                 style="background-image: url({{ asset($jacket_sleeve_buttons_Image) }}); background-size: contain; background-repeat: no-repeat;">
                            </div>
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_sleeve_buttons }}</p>
                            <p class="text-center text-sm mt-2 font-bold">
                                Button Code: {{ strtoupper($selected_overcoat->code_overcoat_button) }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_buttons_colour_on_last_button_hole }}</p>

                            @if($selected_overcoat->overcoat_buttons_colour_on_last_button_hole == 'Yes')
                                <p class="text-center text-sm mt-2 font-bold">
                                    Colour Code: {{ strtoupper($selected_overcoat->code_colour_on_last_button_hole) }}
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_lining }}</p>

                            @if ($selected_overcoat->overcoat_lining !== 'No Lining')
                                <p class="text-center text-sm mt-2 font-bold">
                                    Lining Code: {{ strtoupper($selected_overcoat->code_overcoat_lining) }}
                                </p>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_pockets }}</p>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg flex flex-col items-center">
                        ...
                        <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
                            ...
                            <p class="text-center text-sm mt-2">{{ $selected_overcoat->overcoat_vents }}</p>
                        </div>
                    </div>
