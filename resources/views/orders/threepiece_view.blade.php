...
$Waistcoat_Tape_Images = [
    ...
    'Q010+DD4 Point Bottom' => 'Q010-DD4-Point-Bottom',
...
$Waistcoat_Tape_Image = getImage($Waistcoat_Tape_Images, $selectedItem, 'waistcoat_type', 'waistcoat_types');
...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-3xl text-white leading-tight">
            Three Piece (#{{ $selected_threepiece->id }})
        </h2>
    </x-slot>
    ...
    <h2 class="font-semibold text-m text-gray-800 leading-tight">
        Item Number: (#{{ $selected_threepiece->item_number }})
    </h2>
</div>
...
<div class=" rounded-lg  flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_type }}
        </p>
        <p class="text-center text-sm mt-2 font-bold">
    Jacket Fabric: {{ strtoupper($selected_threepiece->code_jacket) }}
</p>
    </div>
</div>
...
<div class=" rounded-lg  flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_construction }}
        </p>
    </div>
</div>
...
<div class=" rounded-lg  flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_lapel_type }}
        </p>
    </div>
</div>
...
<div class=" rounded-lg  flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_satin_lapel }}
        </p>

        @if (!is_null($selected_threepiece->code_satin_lapel))
    <p class="text-center text-sm mt-2 font-bold">
        Satin Code: {{ strtoupper($selected_threepiece->code_satin_lapel) }}
    </p>
@endif
...
<div class=" rounded-lg  flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_hand_stitch }}
        </p>
    </div>
</div>
...
<div class=" rounded-lg  flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_lapel_width }}
        </p>
    </div>
</div>
...
<div class=" rounded-lg  flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_lapel_functional_button }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_sleeve_buttons }}
        </p>

        <p class="text-center text-sm mt-2 font-bold">
        Jacket Button Code: {{ strtoupper($selected_threepiece->code_jacket_button) }}
    </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_functional_buttons }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_buttons_colour_on_last_button_hole }}
        </p>

        @if($selected_threepiece->jacket_buttons_colour_on_last_button_hole == 'Yes')
        <p class="text-center text-sm mt-2 font-bold">
    Colour Code: {{ strtoupper($selected_threepiece->code_colour_on_last_button_hole) }}
</p>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_lining }}
        </p>

        @if ($selected_threepiece->code_jacket_lining !== 'No Lining')
    <p class="text-center text-sm mt-2 font-bold">
        Lining Code: {{ strtoupper($selected_threepiece->code_jacket_lining) }}
    </p>
@endif
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_pockets }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_pockets_with_flap }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_italian_pockets }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_patch_pockets }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_pockets_satin_piping }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_chest_pocket_type }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->jacket_vents }}
        </p>
    </div>
</div>
...
<div class="bg-emerald-950 grid grid-cols-2 gap-4 place-items-center mx-auto rounded-xl mt-6 mb-6 py-10">
    ...
    <div class="flex flex-col items-center">
        ...
        <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
        <p class="font-bold text-xl">{{ strtoupper($selected_threepiece->code_waistcoat) }}</p>
    ...
    <div class="flex flex-col items-center">
        ...
        <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
        <p class="font-bold text-xl">{{ strtoupper($selected_threepiece->code_waistcoat_buttons) }}</p>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        <div class="w-full h-full bg-cover bg-center rounded-lg" 
             style="background-image: url({{ asset($Waistcoat_Tape_Image) }}); background-size: contain; background-repeat: no-repeat;">
        </div>
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->waistcoat_type }}
        </p>
    </div>
</div>
</div>
...
<div class="bg-emerald-950 grid grid-cols-2 gap-4 place-items-center mx-auto rounded-xl mt-6 mb-6 py-10">
    ...
    <div class="flex flex-col items-center">
        ...
        <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
        <p class="font-bold text-xl">{{ strtoupper($selected_threepiece->code_pants) }}</p>
    ...
    <div class="flex flex-col items-center">
        ...
        <div class="w-48 h-36 flex items-center justify-center border border-white bg-white rounded-lg">
        <p class="font-bold text-xl">{{ strtoupper($selected_threepiece->code_pants_button) }}</p>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_pocket }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_extended_waist_strap }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_pleats }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_back_pocket_type }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_back_pocket_with_buttons }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_back_pocket_with_flap }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_pant_cuffs }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_side_adjusters }}
        </p>
    </div>
</div>
...
<div class="rounded-lg flex flex-col items-center">
    ...
    <div class="w-64 h-80 rounded-xl border flex flex-col items-center justify-between p-4">
        ...
        <p class="text-center text-sm mt-2">
            {{ $selected_threepiece->pants_satin_tape_on_side }}
        </p>
    </div>
</div>
