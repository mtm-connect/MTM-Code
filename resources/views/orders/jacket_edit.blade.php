...
<h2 class="font-semibold text-m text-gray-800 leading-tight mb-10 text-center">
    ...
    <form method="POST" action="{{ route('jackets.update', $selectedjacket->id) }}">
        @csrf
        @method('PUT')
    ...
    <div class="mt-4 grid grid-cols-4 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer group">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selectedjacket->jacket_type ?? '') == 'Single 1 Button' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer group">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selectedjacket->jacket_type ?? '') == 'Single 2 Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer group">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selectedjacket->jacket_type ?? '') == 'Single 3 Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer group">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selectedjacket->jacket_type ?? '') == 'Single 4 Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selectedjacket->jacket_type ?? '') == 'Double Breast 4 on 1' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer" 
                {{ old('jacket_type', $selectedjacket->jacket_type ?? '') == 'Double Breast 6 on 3' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="3 Roll 2" 
                class="hidden peer" 
                {{ old('jacket_type', $selectedjacket->jacket_type ?? '') == '3 Roll 2' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Full Canvas" 
                class="hidden peer"
                {{ old('jacket_construction', $selectedjacket->jacket_construction ?? '') == 'Full Canvas' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Half Canvas" 
                class="hidden peer"
                {{ old('jacket_construction', $selectedjacket->jacket_construction ?? '') == 'Half Canvas' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Notch Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type', $selectedjacket->jacket_lapel_type ?? '') == 'Notch Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Peak Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type', $selectedjacket->jacket_lapel_type ?? '') == 'Peak Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Shawl Lapel" 
                class="hidden peer"
                {{ old('jacket_lapel_type', $selectedjacket->jacket_lapel_type ?? '') == 'Shawl Lapel' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel', $selectedjacket->jacket_satin_lapel ?? '') == 'No Satin Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel', $selectedjacket->jacket_satin_lapel ?? '') == 'Satin Front Lapel' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_satin_lapel', $selectedjacket->jacket_satin_lapel ?? '') == 'Satin Front Including Back Collar' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_hand_stitch', $selectedjacket->jacket_hand_stitch ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_hand_stitch', $selectedjacket->jacket_hand_stitch ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Thinner" 
                class="hidden peer"
                {{ old('jacket_lapel_width', $selectedjacket->jacket_lapel_width ?? '') == 'Thinner' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Regular" 
                class="hidden peer"
                {{ old('jacket_lapel_width', $selectedjacket->jacket_lapel_width ?? '') == 'Regular' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Wider" 
                class="hidden peer"
                {{ old('jacket_lapel_width', $selectedjacket->jacket_lapel_width ?? '') == 'Wider' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Decorative" 
                class="hidden peer"
                {{ old('jacket_lapel_functional_button', $selectedjacket->jacket_lapel_functional_button ?? '') == 'Decorative' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Functional" 
                class="hidden peer"
                {{ old('jacket_lapel_functional_button', $selectedjacket->jacket_lapel_functional_button ?? '') == 'Functional' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-4 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons', $selectedjacket->jacket_sleeve_buttons ?? '') == '2 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons', $selectedjacket->jacket_sleeve_buttons ?? '') == '3 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons', $selectedjacket->jacket_sleeve_buttons ?? '') == '4 Sleeve Buttons' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_sleeve_buttons', $selectedjacket->jacket_sleeve_buttons ?? '') == '5 Sleeve Buttons' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Decorative" 
                class="hidden peer"
                {{ old('jacket_functional_buttons', $selectedjacket->jacket_functional_buttons ?? '') == 'Decorative' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Functional" 
                class="hidden peer"
                {{ old('jacket_functional_buttons', $selectedjacket->jacket_functional_buttons ?? '') == 'Functional' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_buttons_colour_on_last_button_hole', $selectedjacket->jacket_buttons_colour_on_last_button_hole ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_buttons_colour_on_last_button_hole', $selectedjacket->jacket_buttons_colour_on_last_button_hole ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Full Lining" 
                class="hidden peer"
                {{ old('jacket_lining', $selectedjacket->jacket_lining ?? '') == 'Full Lining' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Half Lining" 
                class="hidden peer"
                {{ old('jacket_lining', $selectedjacket->jacket_lining ?? '') == 'Half Lining' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Lining" 
                class="hidden peer"
                {{ old('jacket_lining', $selectedjacket->jacket_lining ?? '') == 'No Lining' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets', $selectedjacket->jacket_pockets ?? '') == 'No Pockets' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="2 Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets', $selectedjacket->jacket_pockets ?? '') == '2 Pockets' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="3 Pockets" 
                class="hidden peer"
                {{ old('jacket_pockets', $selectedjacket->jacket_pockets ?? '') == '3 Pockets' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_pockets_with_flap', $selectedjacket->jacket_pockets_with_flap ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_pockets_with_flap', $selectedjacket->jacket_pockets_with_flap ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_italian_pockets', $selectedjacket->jacket_italian_pockets ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_italian_pockets', $selectedjacket->jacket_italian_pockets ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_patch_pockets', $selectedjacket->jacket_patch_pockets ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_patch_pockets', $selectedjacket->jacket_patch_pockets ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-2 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Yes" 
                class="hidden peer"
                {{ old('jacket_pockets_satin_piping', $selectedjacket->jacket_pockets_satin_piping ?? '') == 'Yes' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No" 
                class="hidden peer"
                {{ old('jacket_pockets_satin_piping', $selectedjacket->jacket_pockets_satin_piping ?? '') == 'No' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type', $selectedjacket->jacket_chest_pocket_type ?? '') == 'Curved Chest Pocket' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type', $selectedjacket->jacket_chest_pocket_type ?? '') == 'Patch Chest Pocket' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                class="hidden peer"
                {{ old('jacket_chest_pocket_type', $selectedjacket->jacket_chest_pocket_type ?? '') == 'Satin Chest Pocket' ? 'checked' : '' }}>
    ...
    <div class="mt-4 grid grid-cols-3 gap-4">
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="No Vent" 
                class="hidden peer"
                {{ old('jacket_vents', $selectedjacket->jacket_vents ?? '') == 'No Vent' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Single Vent" 
                class="hidden peer"
                {{ old('jacket_vents', $selectedjacket->jacket_vents ?? '') == 'Single Vent' ? 'checked' : '' }}>
        ...
        <label class="inline-flex flex-col items-center cursor-pointer">
            <input 
                ...
                value="Double Vent" 
                class="hidden peer"
                {{ old('jacket_vents', $selectedjacket->jacket_vents ?? '') == 'Double Vent' ? 'checked' : '' }}>
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        type="text" 
        name="code_jacket" 
        :value="old('code_jacket', $selectedjacket->code_jacket ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_jacket_lining', $selectedjacket->code_jacket_lining ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_jacket_button', $selectedjacket->code_jacket_button ?? '')" 
        required 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_satin_lapel', $selectedjacket->code_satin_lapel ?? '')" 
...
<div class="mt-2">
    ...
    <x-text-input 
        ...
        :value="old('code_colour_on_last_button_hole', $selectedjacket->code_colour_on_last_button_hole ?? '')" 
